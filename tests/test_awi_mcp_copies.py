...
⚠️ gazebo-chess 于 2026-07-08 迁去 open-chess-robot/sim，不在本仓这份清单里；它那份 awi_mcp.py
与这里几份的一致性**已无自动守卫**——改 AWI 协议时，记得手动去 open-chess-robot/sim/gazebo-chess/awi_mcp.py
同步一份（这条跨仓纪律就登记在此）。
"""
