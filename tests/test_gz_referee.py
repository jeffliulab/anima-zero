"""gazebo-chess 裁判（world/gazebo-chess/referee.py）的离线测试：
...
（不能把 gazebo-chess 目录加 sys.path——它和 conftest 已加的 sim-chess 目录有同名模块 world/config）。
"""
