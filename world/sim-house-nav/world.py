...
GUIDANCE = (
    ...
    "**别走几步就停下来问用户**——一直找到为止。两种情况才收尾：**找到了**（看清了目标房间，判据见下），\n"
    ...
    "各房间的墙色和地面材质也不一样，可以自己看着当辅助线索，但**认出标志物才是主要判据**。\n"
)
