...
GUIDANCE = (
    ...
    "\n"
    "【什么才算「到了」某个房间——别提前宣布】⚠️ 隔着门洞**看见**目标房间，不等于**已经到了**。\n"
    "站在客厅门口望进厨房，你人还在客厅。你必须真的**走进去**才算到。\n"
    "**最可靠的判据是看你脚下**：每个房间的地面材质不一样——客厅是深色木地板，厨房是浅色瓷砖，\n"
    "卧室是浅木色，玄关是白色大理石。看画面**下方靠近自己**的那片地面是什么颜色，就知道自己此刻站在哪个房间里。\n"
    "如果脚下还是深色木地板、浅色瓷砖只出现在画面远处的门框那头，说明你还在客厅、还没进厨房，\n"
    "继续往前走，直到**脚下**变成瓷砖。\n"
)
